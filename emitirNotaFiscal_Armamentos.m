...
NSDictionary *parameters = @{ @"ID": @1137,
                              ...
                              @"produtos": @[ @{ @"nome": @"Nome do produto", @"codigo": @"nome-do-produto", @"ncm": @"6109.10.00", @"cest": @"28.038.00", @"quantidade": @3, @"unidade": @"UN", @"peso": @"0.800", @"origem": @"", @"subtotal": @"44.90", @"total": @"134.70", @"classe_imposto": @"REF2892", @"armamentos": @{ @"tipo": @"", @"serie_arma": @"000000", @"serie_cano": @"000000", @"descricao": @"..." } } ],
