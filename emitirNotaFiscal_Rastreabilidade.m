...
NSDictionary *parameters = @{ @"ID": @1137,
                              ...
                              @"produtos": @[ @{ @"nome": @"Nome do produto", @"codigo": @"nome-do-produto", @"ncm": @"6109.10.00", @"cest": @"28.038.00", @"quantidade": @3, @"unidade": @"UN", @"peso": @"0.800", @"origem": @"", @"subtotal": @"44.90", @"total": @"134.70", @"classe_imposto": @"REF2892", @"rastro": @{ @"lote": @"000001", @"quantidade": @"100", @"data_fabricacao": @"2018-01-01", @"data_validade": @"2020-01-01" } } ],
